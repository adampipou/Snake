...
class Jeu:
    def __init__(self):
        ...
        self.image_tete_serpent =pygame.transform.scale(self.image_tete_serpent, (30, 30))


        # Charger l'image

        self.image = pygame.image.load('la_tete_du_serpent.png')
        # retrecir l'image
    ...
    def fonction_principale(self):
        ...
        while self.jeu_encours:
            ...
            poule = []
            poule.append(self.serpent_position_x)
            poule.append(self.serpent_position_y)


            # append dans la liste des positions du serpent

            self.positions_serpent.append(poule)
